...
import GoVoyage.GUIs.PersonneList;
 ...
 * @author SASSOU
 */
public class personneDeleteForm extends Form implements CommandListener, Runnable{
    ...
    public personneDeleteForm(String title) {
        super(title);
    }
         public personneDeleteForm() {

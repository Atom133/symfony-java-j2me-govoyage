...
public class SplashScreen1 extends Canvas implements Runnable {
     ...
     */
    public SplashScreen1(Midlet projectMIDlet){
        this.projectMIDlet = projectMIDlet;
        try{
        mImage = Image.createImage("GoVoyage/Splashes/splash1.png");
    ...
    public void dismiss() {
        if (isShown())
            Display.getDisplay(projectMIDlet).setCurrent(new SplashScreen2(projectMIDlet));

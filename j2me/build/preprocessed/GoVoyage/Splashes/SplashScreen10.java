 ...
 * @author lenovo
 */
public class SplashScreen10 extends Canvas implements Runnable {
     ...
     */
    public SplashScreen10(Midlet projectMIDlet){
        this.projectMIDlet = projectMIDlet;
        try{
        mImage = Image.createImage("GoVoyage/Splashes/splash10.png");
    ...
    public void dismiss() {
        if (isShown())
            Display.getDisplay(projectMIDlet).setCurrent(new SplashScreen11(projectMIDlet));
    ...
    public void run() {
        try {
            Thread.sleep(200);//set for 3 seconds
        }

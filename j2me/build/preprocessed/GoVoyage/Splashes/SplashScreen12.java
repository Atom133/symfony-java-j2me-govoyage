 ...
 * @author lenovo
 */
public class SplashScreen12 extends Canvas implements Runnable {
     ...
     */
    public SplashScreen12(Midlet projectMIDlet){
    ...
    public void dismiss() {
        if (isShown())
            Display.getDisplay(projectMIDlet).setCurrent(new ExpList());

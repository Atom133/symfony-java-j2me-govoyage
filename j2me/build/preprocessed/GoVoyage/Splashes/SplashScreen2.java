...
public class SplashScreen2 extends Canvas implements Runnable {
     ...
     */
    public SplashScreen2(Midlet projectMIDlet){
        this.projectMIDlet = projectMIDlet;
        try{
        mImage = Image.createImage("GoVoyage/Splashes/splash2.png");
    ...
    public void dismiss() {
        if (isShown())
            Display.getDisplay(projectMIDlet).setCurrent(new SplashScreen3(projectMIDlet));

...
public class SplashScreen5 extends Canvas implements Runnable {
     ...
     */
    public SplashScreen5(Midlet projectMIDlet){
        this.projectMIDlet = projectMIDlet;
        try{
        mImage = Image.createImage("GoVoyage/Splashes/splash5.png");
    ...
    public void dismiss() {
        if (isShown())
            Display.getDisplay(projectMIDlet).setCurrent(new SplashScreen6(projectMIDlet));

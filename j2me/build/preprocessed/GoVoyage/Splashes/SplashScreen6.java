 ...
 * @author lenovo
 */
public class SplashScreen6 extends Canvas implements Runnable {
     ...
     */
    public SplashScreen6(Midlet projectMIDlet){
        this.projectMIDlet = projectMIDlet;
        try{
        mImage = Image.createImage("GoVoyage/Splashes/splash6.png");
    ...
    public void dismiss() {
        if (isShown())
            Display.getDisplay(projectMIDlet).setCurrent(new SplashScreen7(projectMIDlet));

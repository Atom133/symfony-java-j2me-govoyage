...
import GoVoyage.GUIs.AdminExp;
import GoVoyage.GUIs.ExpList;
 ...
 * @author lenovo
 */
public class SplashScreen_ExpA extends Canvas implements Runnable {
     ...
     */
    public SplashScreen_ExpA(Midlet projectMIDlet){
        this.projectMIDlet = projectMIDlet;
        try{
        mImage = Image.createImage("GoVoyage/Splashes/splash12.png");
    ...
    public void dismiss() {
        if (isShown())
            Display.getDisplay(projectMIDlet).setCurrent(new AdminExp());

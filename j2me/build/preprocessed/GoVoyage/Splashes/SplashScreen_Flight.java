 ...
 * @author sawsse
 */
public class SplashScreen_Flight extends Canvas implements Runnable {
     ...
     */
    public SplashScreen_Flight(Midlet projectMIDlet){
        this.projectMIDlet = projectMIDlet;
        try{
        mImage = Image.createImage("GoVoyage/Splashes/splash_flight.png");
    ...
    public void dismiss() {
        if (isShown())
           // Display.getDisplay(projectMIDlet).setCurrent(new login());
            Display.getDisplay(projectMIDlet).setCurrent(new VolList());

...
import GoVoyage.GUIs.HotList;
import GoVoyage.GUIs.HotUser;
 ...
 */
public class SplashScreen_HotelM extends Canvas implements Runnable {
     ...
     */
    public SplashScreen_HotelM(Midlet projectMIDlet){
        this.projectMIDlet = projectMIDlet;
        try{
        mImage = Image.createImage("GoVoyage/Splashes/splash_hotel.png");
    ...
    public void dismiss() {
        if (isShown())
            Display.getDisplay(projectMIDlet).setCurrent(new HotUser());

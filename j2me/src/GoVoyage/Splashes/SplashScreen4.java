...
public class SplashScreen4 extends Canvas implements Runnable {
     ...
     */
    public SplashScreen4(Midlet projectMIDlet){
        this.projectMIDlet = projectMIDlet;
        try{
        mImage = Image.createImage("GoVoyage/Splashes/splash4.png");
    ...
    public void dismiss() {
        if (isShown())
            Display.getDisplay(projectMIDlet).setCurrent(new SplashScreen5(projectMIDlet));

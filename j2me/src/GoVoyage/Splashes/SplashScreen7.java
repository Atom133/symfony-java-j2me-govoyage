 ...
 * @author lenovo
 */
public class SplashScreen7 extends Canvas implements Runnable {
     ...
     */
    public SplashScreen7(Midlet projectMIDlet){
        this.projectMIDlet = projectMIDlet;
        try{
        mImage = Image.createImage("GoVoyage/Splashes/splash7.png");
    ...
    public void dismiss() {
        if (isShown())
            Display.getDisplay(projectMIDlet).setCurrent(new SplashScreen8(projectMIDlet));

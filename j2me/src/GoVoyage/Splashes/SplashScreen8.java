 ...
 * @author lenovo
 */
public class SplashScreen8 extends Canvas implements Runnable {
     ...
     */
    public SplashScreen8(Midlet projectMIDlet){
        this.projectMIDlet = projectMIDlet;
        try{
        mImage = Image.createImage("GoVoyage/Splashes/splash8.png");
    ...
    public void dismiss() {
        if (isShown())
            Display.getDisplay(projectMIDlet).setCurrent(new SplashScreen9(projectMIDlet));

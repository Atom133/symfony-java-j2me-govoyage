 ...
 * @author lenovo
 */
public class SplashScreen9 extends Canvas implements Runnable {
     ...
     */
    public SplashScreen9(Midlet projectMIDlet){
        this.projectMIDlet = projectMIDlet;
        try{
        mImage = Image.createImage("GoVoyage/Splashes/splash9.png");
    ...
    public void dismiss() {
        if (isShown())
            Display.getDisplay(projectMIDlet).setCurrent(new SplashScreen10(projectMIDlet));

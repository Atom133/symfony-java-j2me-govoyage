 ...
 */
public class SplashScreen_HotelA extends Canvas implements Runnable {
     ...
     */
    public SplashScreen_HotelA(Midlet projectMIDlet){
    ...
    public void dismiss() {
        if (isShown())
            Display.getDisplay(projectMIDlet).setCurrent(new HotList());

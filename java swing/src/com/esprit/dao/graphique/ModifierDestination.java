 ...
 * @author Sony
 */
public class ModifierDestination extends javax.swing.JFrame{
Destination d;
    /**
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Modifier la destination ");
    ...
    private void validActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_validActionPerformed
      ...
      description=getjTextField3().getText();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ModifierDestination.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                new ModifierDestination().setVisible(true);

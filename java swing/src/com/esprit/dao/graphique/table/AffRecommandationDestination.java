 ...
 * @author Sony
 */
public class AffRecommandationDestination extends AbstractTableModel{
  String[] entete ={"description", "Destination","Pays"};
    List<Recommandation> dest= new ArrayList<>();
    RecommandationDAO DAO =new RecommandationDAO ();
    Fos_user ut;
    public AffRecommandationDestination(Fos_user u) {
         this.ut=u;  
         dest=DAO.displayRecommadationDestination(u);
    }
    ...
    public Object getValueAt(int rowIndex, int columnIndex) {
        switch (columnIndex) {
            ...
            case 0:
                ...
                return dest.get(rowIndex).getDestination().getAdresse();
            case 2:

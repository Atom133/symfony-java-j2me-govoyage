 ...
 * @author Sony
 */
public class AffRecommandationDestinationALL extends AbstractTableModel{
  String[] entete ={"description", "Destination"};
    List<Recommandation> dest= new ArrayList<>();
    RecommandationDAO DAO =new RecommandationDAO ();
   
    public AffRecommandationDestinationALL() {
         
         dest=DAO.displayRecommadationDestination();
    }

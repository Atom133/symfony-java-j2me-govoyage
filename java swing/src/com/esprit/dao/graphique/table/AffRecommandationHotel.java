 ...
 * @author Sony
 */
public class AffRecommandationHotel extends AbstractTableModel{
  String[] entete ={"description", "Hotel","Pays"};
    ...
    public AffRecommandationHotel(Fos_user u) {
         this.ut=u;  
         dest=DAO.displayRecommadationHotel(u);
    }

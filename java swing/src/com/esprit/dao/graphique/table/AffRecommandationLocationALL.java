 ...
 * @author Sony
 */
public class AffRecommandationLocationALL extends AbstractTableModel{
  String[] entete ={"description", "adresse"};
    List<Recommandation> dest= new ArrayList<>();
    RecommandationDAO DAO =new RecommandationDAO ();
   
    public AffRecommandationLocationALL() {
      
         dest=DAO.displayRecommadationlocationVacance();
    }

 ...
 * @author Sony
 */
public class AffRecommandationRestaurent extends AbstractTableModel{
  String[] entete ={"description", "Nom","Pays"};
    ...
    public AffRecommandationRestaurent(Fos_user u) {
         this.ut=u;  
         dest=DAO.displayRecommadationRestaurent(u);
    }
